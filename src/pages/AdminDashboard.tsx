  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      <nav className="bg-white shadow-sm border-b mb-6">
        <div className="container mx-auto px-6 py-2 flex gap-4">
          <NavLink to="/admin-dashboard" className={({ isActive }) => `flex items-center gap-2 px-3 py-2 rounded-md font-medium transition-colors ${isActive ? 'bg-blue-100 text-blue-700' : 'text-gray-700 hover:bg-gray-100'}`} end>
            <Users className="h-5 w-5" /> Dashboard
          </NavLink>
          <NavLink to="/manage-batches" className={({ isActive }) => `flex items-center gap-2 px-3 py-2 rounded-md font-medium transition-colors ${isActive ? 'bg-green-100 text-green-700' : 'text-gray-700 hover:bg-gray-100'}`}>
            <BarChart3 className="h-5 w-5" /> Manage Batches
          </NavLink>
          <NavLink to="/total-trainees" className={({ isActive }) => `flex items-center gap-2 px-3 py-2 rounded-md font-medium transition-colors ${isActive ? 'bg-purple-100 text-purple-700' : 'text-gray-700 hover:bg-gray-100'}`}>
            <Users className="h-5 w-5" /> Total Trainees
          </NavLink>
          <NavLink to="/active-trainees" className={({ isActive }) => `flex items-center gap-2 px-3 py-2 rounded-md font-medium transition-colors ${isActive ? 'bg-orange-100 text-orange-700' : 'text-gray-700 hover:bg-gray-100'}`}>
            <TrendingUp className="h-5 w-5" /> Active Trainees
          </NavLink>
        </div>
      </nav>
