...
class Settings:
    ...
    # Application settings
    APP_NAME: str = os.getenv("APP_NAME", "Maverick Dashboard")
    APP_VERSION: str = os.getenv("APP_VERSION", "1.0.0")
    DEBUG: bool = os.getenv("DEBUG", "True").lower() == "true"
    
    # CORS settings
    ALLOWED_ORIGINS: list = os.getenv("ALLOWED_ORIGINS", "http://localhost:8080,http://localhost:8081,http://localhost:8082,http://localhost:8083,http://localhost:5173,http://localhost:3000,https://localhost:8080").split(",")
    ...
    # Email templates
    WELCOME_EMAIL_SUBJECT: str = os.getenv("WELCOME_EMAIL_SUBJECT", "🎉 Welcome to Maverick Dashboard - Your Training Journey Begins!")
    PASSWORD_RESET_SUBJECT: str = os.getenv("PASSWORD_RESET_SUBJECT", "🔐 Maverick Dashboard - Password Reset")
